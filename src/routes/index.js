...
import { fidelidadeRouter, fidelidadeAdminRouter } from '../modules/loyalty/routes.js';
...
router.use('/fidelidade', fidelidadeRouter);
router.use('/wallet', walletRouter);
router.use('/bar-orders', barRouter);
router.use('/admin', adminRouter);
router.use('/admin', fidelidadeAdminRouter);
